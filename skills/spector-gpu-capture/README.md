...
> For multi-step agent workflows, prefer the stateful [Spector.GPU MCP server](../../mcp/README.md). This CLI is retained for one-shot captures and clients without MCP support.
